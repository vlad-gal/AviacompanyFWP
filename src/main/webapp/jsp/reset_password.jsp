                        ...
                        <form method="POST" name="resetPasswordForm"
                            ...
                            <div class="form-group m-2">
                                ...
                                <input id="password" type="password" class="form-control" name="password"
                                       ...
                                       value="" pattern="[^\s]{8,25}"
                                       title="<fmt:message key="local.incorrectPasswordMessage"/>" required
                                       autofocus>
                                ...
                                <c:if test="${emailNotExistFlag eq true}">
                                    <div class="errorLoginPass">
                                        <p class="errorLoginPass text-center"><fmt:message key="local.emailNotExist"/></p>
                                    </div>
                                </c:if>
                            </div>
