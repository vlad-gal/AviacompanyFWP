...
<head>
    ...
    <title><fmt:message key="local.updateAirport"/></title>
</head>
    ...
    <div class="container">
        <div class="row justify-content-md-center">
            <div class="card-wrapper">
                <div class="card fat">
                    <div class="card-body">
                        <h5 class="card-title text-center"><fmt:message key="local.updateAirport"/></h5>
                        <c:if test="${errorUpdateAirportFlag eq true}">
                            <h6 class="errorLoginPass text-center"><fmt:message key="local.errorUpdating"/></h6>
                        </c:if>
                        <c:if test="${updateAirportSuccessfulFlag eq true}">
                        ...
                        <form method="POST" name="updateAirportForm" action="${pageContext.request.contextPath}/controller">
                            <input type="hidden" name="command" value="update_airport">
                            <div class="form-group">
                                ...
                                <input id="airportName" type="text" class="form-control" name="airportName"
                                       ...
                                       value="${updatingAirport.airportName}" autofocus required>
                            </div>
                            <c:if test="${errorValidationFlag eq true}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="city" type="text" class="form-control" name="city"
                                       ...
                                       value="${updatingAirport.city}" required>
                            </div>
                            <c:if test="${errorValidationFlag eq true}">
                                <div class="errorLoginPass">
                            ...
                            <div class="form-group">
                                ...
                                <input id="country" type="text" class="form-control" name="country"
                                       ...
                                       value="${updatingAirport.country}" required>
                            </div>
                            <c:if test="${errorValidationFlag eq true}">
                                <div class="errorLoginPass">
